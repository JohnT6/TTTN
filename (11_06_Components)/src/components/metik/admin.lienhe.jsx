    ...
    return (
        <section className="py-10 md:py-16" style={getBackgroundStyle(background)}>
            <div className="max-w-[1400px] mx-auto px-4 md:px-8">
                <div className={`flex flex-col ${isTextLeft ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-10 lg:gap-16 items-start`}>
                            ...
                            <div className="flex flex-wrap gap-3 pt-4">
                                {socialItems.map((soc, j) => (
                                    <a 
                                        key={j}
                                        href={soc.url || '#'}
                                        className="px-4 py-2 text-sm font-semibold border flex items-center gap-2 hover:opacity-80 transition-opacity"
                                        style={{
                                            backgroundColor: soc.buttonStyle?.bgColor || '#e0f2f1',
                                            borderColor: soc.buttonStyle?.borderColor || 'transparent',
                                            borderRadius: getCustomRadius(soc.buttonStyle?.radius),
                                            color: soc.buttonStyle?.color || '#00695c',
...
export default AdminLienHeMetik;
